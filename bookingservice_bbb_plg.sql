...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Mar 2025 pada 17.03
...
CREATE TABLE `detail_booking` (
  ...
  `biaya_10km` double(15,8) DEFAULT NULL,
  `ask_extra` varchar(255) DEFAULT NULL,
  `biaya_extra` double(15,8) DEFAULT NULL,
...
(5, '2025_03_17_084012_create_services_table', 1),
(6, '2025_03_17_084131_create_bookings_table', 1),
(7, '2025_03_18_063544_create_detail_bookings_table', 1);
...
CREATE TABLE `services` (
  ...
  `biaya` double(15,8) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
