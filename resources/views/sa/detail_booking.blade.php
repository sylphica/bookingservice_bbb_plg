                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-md btn-warning" href="{{ route('sa.booking') }}">
                                Kembali</a>
                        </div>
                    </div>
                    <div class="box-body table-responsive">
                        ...
                        <form action="{{ route('sa.updateBooking') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p>Biaya Pekerjaan Tambahan :</p>
                                    <input type="number" name="biaya_extra" class="form-control" required>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-4">
                                    <p>Upload PDF Estimasi :</p>
