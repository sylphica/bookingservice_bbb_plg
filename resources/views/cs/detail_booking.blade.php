                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-md btn-warning" href="{{ route('cs.booking') }}">
                                Kembali</a>
                        </div>
                    </div>
                    <div class="box-body table-responsive">
                        ...
                        <form action="{{ route('cs.updateBooking') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p>Tanggal Service :</p>
                                    <input type="date" name="biaya_extra" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p>Catatan :</p>
                                    <textarea name="catatan" class="form-control" cols="3" rows="2">{{ @$booking->catatan }}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p>Apakah Lokasi Lebih dari 10 Km dari Dealer <b>:
                                            {{ @$detail->ask_10km ?? 'TIDAK' }}</b></p>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="status" class="form-control" required>
                                        ...
                                        <option value="MENUNGGU KONFIRMASI SP">MENUNGGU KONFIRMASI SP</option>
                                        @if ($detail->ask_extra == 'YA')
                                            <option value="MENUNGGU KONFIRMASI SA">MENUNGGU KONFIRMASI SA</option>
                                        @endif
                                        @if ($booking->jenis_service == 'HOME SERVICE')
                                            <option value="MENUNGGU KONFIRMASI SM">MENUNGGU KONFIRMASI SM</option>
                                        @endif
                                        <option value="MENUNGGU KONFIRMASI CUSTOMER">MENUNGGU KONFIRMASI CUSTOMER</option>
