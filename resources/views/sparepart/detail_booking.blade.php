                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-md btn-warning" href="{{ route('sparepart.booking') }}">
                                Kembali</a>
                        </div>
                    </div>
                    <div class="box-body table-responsive">
                        <div class="row">
                            <center>
                                <h2 class="login-box-msg"> Detail</h2>
                                @if (\Session::has('msg_success'))
                                    <h5>
                        ...
                        <form action="{{ route('sparepart.updateBooking') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="konfirmasi_sparepart" class="form-control" required>
                                ...
                                <div class="col-md-4">
                                    <p>Biaya Pekerjaan Tambahan <b>: Rp.
