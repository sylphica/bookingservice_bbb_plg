                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-md btn-info" target="_blank" href="{{ route('mekanik.pdf', $booking->id) }}">
                                <i class="fa fa-print"></i> Riwayat</a>
                            <a class="btn btn-md btn-warning" href="{{ route('mekanik.service') }}">
                                Kembali</a>
                        </div>
                    </div>
                    <div class="box-body table-responsive">
                        <div class="row">
                            <center>
                                <h2 class="login-box-msg"> Detail Service</h2>
                        ...
                        <form action="{{ route('mekanik.updateService') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p>Nama Customer <b>: {{ @$booking->Customer->name }}</b></p>
                                </div>
                                <div class="col-md-4">
                                    <p>No HP <b>: {{ @$booking->Customer->no_hp }}</b></p>
                                </div>
                                <div class="col-md-4">
                                    <p>Alamat <b>: {{ @$booking->Customer->alamat }}</b></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-2 col-xs-offset-5">
                                    <button style="margin: 50px;" type="submit" class="btn btn-primary"
                                        style="border-radius: 10px">Selesai</button>
                                </div>
                            </div>
                            <br>
                            <br>
