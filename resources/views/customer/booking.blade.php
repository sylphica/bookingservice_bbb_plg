                                ...
                                <div class="col-md-12">
                                    <div id="dynamicInputs">
                                        <div class="form-group input-group">
                                            <div class="col-md-5">
                                                <label>Nama :</label>
                                                <input type="text" name="sparePart[]" placeholder="Nama Spare Part"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-5">
                                                <label>Jumlah :</label>
                            ...
                            <tbody>
                                @foreach (@$booking as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ @$value->catatan }}</td>
                                        <td>
                                            <a href="{{ route('customer.detailBooking', $value->id) }}"><button
                                                    class="btn btn-xs btn-primary"><i class="fa fa-edit">
                                                        Detail</i></button></a>
                                            @if ($value->status == 'MENUNGGU KONFIRMASI')
                                                <a href="{{ route('customer.deleteBooking', $value->id) }}"><button
    ...
    <script>
        $(document).ready(function() {
            $('#addInput').click(function() {
                ...
                <div class="form-group input-group">
                    <div class="col-md-5">
                        <input type="text" name="sparePart[]" class="form-control" placeholder="Nama Spare Part">
                    </div>
                    <div class="col-md-5">
