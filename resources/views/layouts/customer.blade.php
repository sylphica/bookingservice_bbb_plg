                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item {{ request()->routeIs('customer.daftar') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('customer.daftar') }}">Daftar Service</a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('customer.booking') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('customer.booking') }}">Booking</a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('customer.profile') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('customer.profile') }}"><i
                                                class="fa fa-user-circle padd_right" aria-hidden="true"></i>Profile</a>
                                    </li>
