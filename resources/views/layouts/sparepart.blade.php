...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/sparepart/home" class="logo">
                <span class="logo-mini"><b>SP</b></span>
                <span class="logo-lg"><b>Sparepart</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('sparepart.sparepart') }}">
                            <i class="fa fa-columns"></i> <span>Data Sparepart</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sparepart.booking') }}">
                            <i class="fa fa-edit"></i> <span>Data Booking</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sparepart.profile') }}">
