    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/sa/home" class="logo">
                ...
                <span class="logo-lg"><b>Service Advisor</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('sa.booking') }}">
                            <i class="fa fa-edit"></i> <span>Data Booking</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sa.history') }}">
                            <i class="fa fa-list"></i> <span>Data History</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sa.profile') }}">
