...
class CSController extends Controller
{
    ...
    function detailBooking($id) {
        ...
        return view('cs.detail_booking', compact('title','booking','detail'));
    }
    ...
    function detailService($id) {
        ...
        $booking = Booking::find($id);
        $detail = DetailBooking::where('booking_id',$booking->id)->first();
        return view('cs.detail_service', compact('title','booking','detail','mekanik'));
    }
    ...
    function detailHistory($id) {
        ...
        $booking = Booking::find($id);
        $detail = DetailBooking::where('booking_id',$booking->id)->first();
        return view('cs.detail_history', compact('title','booking','detail'));
    }
}
