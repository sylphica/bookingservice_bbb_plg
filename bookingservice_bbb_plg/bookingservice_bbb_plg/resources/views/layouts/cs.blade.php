...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/cs/home" class="logo">
                <span class="logo-mini"><b>CS</b></span>
                <span class="logo-lg"><b>Customer Service</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('cs.booking') }}">
                            <i class="fa fa-edit"></i> <span>Data Booking</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cs.service') }}">
                            <i class="fa fa-list-alt"></i> <span>Data Service</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cs.history') }}">
                            <i class="fa fa-list"></i> <span>Data History Service</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cs.profile') }}">
