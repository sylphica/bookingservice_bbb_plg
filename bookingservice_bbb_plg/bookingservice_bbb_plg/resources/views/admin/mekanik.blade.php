                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-rspad"><i class="fa fa-edit">
                                                    Ubah</i></button> &nbsp;
                                            <a href="{{ route('admin.deleteMekanik', $value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Tambah Data Mekanik</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.addMekanik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-form-edit-rspad" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Form Ubah Data Mekanik</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.updateMekanik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
